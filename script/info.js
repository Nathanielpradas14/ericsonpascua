...
module.exports.run = async function({ api, event, args, prefix, admin }) {
		...
		const CREATORLINK = "https://www.facebook.com/ericsonpascua6";
		const BOTCREATOR = "ericsonpascua";
		const BOTNAME = "ericsom";
...
⁂ Bot Name: ${name}
✧ Bot Admin: ${admin}
♛ Bot Admin Link: https://www.facebook.com/ericsonpascua6
❂ Bot Prefix: ${prefix}
